...
        yield l
```
С полным кодом можно ознакомится в файле [fib_iterator.py]()
...
```
С полным набором тестов можно ознакомится в файле [test_fib.py]()
...
С полным кодом можно ознакомится в файле [fit_iterator.py]()
...
```
Со всеми остальными тестами можно ознакомится в файле [test_fib_it.py]()
